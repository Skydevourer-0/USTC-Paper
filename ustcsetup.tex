...
\ustcsetup{
  title                = {多维度覆盖率融合显示系统的设计与实现},
  title*               = {Design and Implementation of a Multidimensional Coverage Data Fusion Display System},
  author               = {阮乐天},
  author*              = {Ruan Letian},
  speciality           = {软件工程},
  ...
  supervisor           = {陈博},
  supervisor*          = {Chen Bo},
  practice-supervisor  = {钟万勇},
  practice-supervisor* = {Zhong Wanyong},
