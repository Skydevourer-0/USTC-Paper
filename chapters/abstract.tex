...
\ustcsetup{
  keywords  = {多维度代码覆盖率, 嵌入式软件, 异构平台支持},
  keywords* = {Multidimensional code coverage, Embedded software, Heterogeneous platform support},
}
